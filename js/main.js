...
async function getWeather() {
    ...
    const apiKey = 'ee79a07adbmsh11c639b96736b8cp13966ajsn3914323ea9f0';
    ...
    try {
        ...
        if (data.error) {
      document.getElementById('weatherInfo').innerHTML = 'Error: ' + data.error.description;
      return;
    }
  
      const weatherInfo = `
        <h2>${data.location.city}, ${data.location.country}, ${data.location.lat} , ${data.location.long}</h2>
        <p>Current Condition: ${data.current_observation.condition.text}</p>
